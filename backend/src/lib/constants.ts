...
/**
 * (optional) InPost fulfillment configuration
 */
export const INPOST_API_TOKEN = process.env.INPOST_API_TOKEN;
export const INPOST_ORGANIZATION_ID = process.env.INPOST_ORGANIZATION_ID;
export const INPOST_WEBHOOK_URL = process.env.INPOST_WEBHOOK_URL;
export const INPOST_GEOWIDGET_TOKEN = process.env.INPOST_GEOWIDGET_TOKEN;
